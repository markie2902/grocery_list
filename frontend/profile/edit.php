    ...
    if(isset($_POST['submit']) && $_POST['submit'] == 'Update'){
      ...
      if(isset($_GET["redirect"])){
        ...
        //else{  
          ...
          //$user_redirect = urlencode("http://" . $_SERVER["HTTP_HOST"] . dirname($_SERVER["PHP_SELF"]) . "/profile.php");
...
?>
  ...
  <form enctype="multipart/form-data" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
      ...
      <option value="Male" <?php if (!empty($user_gender) && $user_gender == "Male") echo 'selected = "selected"'; ?>>M</option>
      <option value="Female" <?php if (!empty($user_gender) && $user_gender == "Female") echo 'selected = "selected"'; ?>>F</option>
      </select><br>
      Birth Date:<br>
